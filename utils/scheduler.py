"""
Scheduler module for periodic post sync
"""
import logging
...
def _run_sync():
    """Background job to sync posts from filesystem to database"""
...
def init_scheduler(app):
    ...
    scheduler.start()
    logger.info(f"Post sync scheduler started (interval: {app.config['POSTS_CHECK_INTERVAL']}s)")
